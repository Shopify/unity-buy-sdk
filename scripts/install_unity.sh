...
UNITY_PKG_URL=${UNITY_PKG_URL:-https://netstorage.unity3d.com/unity/cc85bf6a8a04/MacEditorInstaller/Unity-2017.1.2f1.pkg}
IOS_PKG_LOCATION=${IOS_PKG_LOCATION:-"$UNITY_DOWNLOAD_DIR"/Unity-iOS.pkg}
IOS_PKG_URL=${IOS_PKG_URL:-http://netstorage.unity3d.com/unity/cc85bf6a8a04/MacEditorTargetInstaller/UnitySetup-iOS-Support-for-Editor-2017.1.2f1.pkg}
